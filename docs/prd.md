...
**Depends on:** EV-19
**Satisfies:** QA-019
**Acceptance:** a bundle vector reproduced identically by both implementations, a requirement with no vector reported by count and by name, and a refusal probe for a rule no implementation previously had.
